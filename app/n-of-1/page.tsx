                ...
                <div className="section">
                    ...
                    <div style={{ marginTop: 8 }}>
                        {[
                            ...
                            { date: "Feb 2026", color: "#444", event: "Root Frequency Theory published · M-RFT metric registered", desc: "Fourteen months of first-person observation crystallize into a formal framework. C0–C4 nested architecture. M = (Φ · Kₑ) / F. Preprint registered with DOI (embargoed). The metric precedes the instrument — the theoretical pattern preceded the measurement instrument." },
